...
export async function generateMetadata({ params: { locale, slug } }) {
  ...
  return {
    ...
    openGraph: {
      title: category.metaTitle[locale],
      description: category.metaDescription[locale],
      url: `https://rybka.space/${locale}/category/${slug}`,
    ...
    alternates: {
      canonical: `https://rybka.space/${locale}/category/${slug}`,
      languages: {
        'uk': `https://rybka.space/uk/category/${category.slug['uk']}`,
        'ru': `https://rybka.space/ru/category/${category.slug['ru']}`,
      },
    },
  };
}
...
export default async function CategoryPage({ params: { locale, slug } }) {
  ...
  const url = `https://rybka.space/${locale}/category/${slug}`;
